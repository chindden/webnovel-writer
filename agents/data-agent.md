---
name: data-agent
description: 数据处理Agent，负责AI实体提取、场景切片、索引构建、向量嵌入。在章节完成后自动调用，处理数据链的写入工作。
...
{
  "entities_extracted": [
    {"id": "xiaoyan", "mentions": ["萧炎", "他"], "confidence": 0.95}
  ],
  "entities_new": [
  ...
  "scenes_chunked": 4,
  "vectors_stored": true,
  "style_sample_candidate": true,
  "uncertain": [
    {"mention": "那位前辈", "candidates": ["yaolao", "elder_zhang"], "confidence": 0.6}
  ],
  "warnings": []
}
```
...
```json
{
  "entities_appeared": [
    {"id": "xiaoyan", "mentions": ["萧炎", "他"], "confidence": 0.95},
    {"id": "yaolao", "mentions": ["药老"], "confidence": 0.92},
  ...
  "uncertain": [
    {"mention": "那位前辈", "context": "那位前辈看了他一眼", "candidates": ["yaolao", "elder_zhang"], "suggested": "yaolao", "confidence": 0.6}
  ]
}
```
...
**注册新别名**:
```bash
python -m data_modules.entity_linker register-alias --entity "hongyi_girl" --alias "红衣女子" --project-root "."
```
...
```json
{
  ...
  "style_sample_candidate": true,
  "uncertain": [
    {"mention": "那位前辈", "candidates": ["yaolao", "elder_zhang"], "adopted": "yaolao", "confidence": 0.6}
  ],
  "warnings": [
